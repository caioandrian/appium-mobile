...
const CT_Appium_Menu = require('../../../pages/app_android/ct_appium/menu/index');
const CT_Appium_Abas = require('../../../pages/app_android/ct_appium/abas/index');
const CT_Appium_DragNdrop = require('../../../pages/app_android/ct_appium/dragndrop/index');
const CT_Appium_Formulario = require('../../../pages/app_android/ct_appium/formulario/index');
