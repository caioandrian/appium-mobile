...
class CT_Appium_Formulario extends Base{
    ...
    async preencher_dados(){
        ...
        await super.validateElementIsChecked(el.FORM.INPUT_CHECKBOX)

        await super.clickElement(el.FORM.INPUT_SWITCH, false)
        await super.validateElementIsChecked(el.FORM.INPUT_SWITCH, false)
        ...
        await super.slideElementByHorizontal(el.FORM.FORM_SEEKER, 1)
